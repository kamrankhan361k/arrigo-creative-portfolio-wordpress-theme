 ...
 * @return array
 */
add_filter( 'upload_mimes', 'arr_custom_mime_types', 60 );
function arr_custom_mime_types( $mime_types ) {
 ...
 */
add_filter( 'wp_check_filetype_and_ext', 'arr_custom_file_ext', 10, 4 );
function arr_custom_file_ext( $types, $file, $filename, $mimes ) {
